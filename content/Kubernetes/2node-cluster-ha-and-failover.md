...
하지만 주어진 제약사항이 명확했다. 바로 운영 환경의 <b>워커 노드가 단 2대</b>라는 점이다. 노드 하나만 다운되어도 전체 파드 가용 자원의 50%가 날아간다. Ceph나 Mayastor처럼 기본적으로 3개 이상 노드를 요구하는 분산 스토리지는 애초에 검토 대상에서 빠졌다.
