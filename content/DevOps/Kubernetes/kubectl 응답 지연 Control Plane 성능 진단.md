...
솔직히 말하면 다음 날 다시 봤을 때 증상은 이미 완화돼 있었다. 응답도 정상 범위로 돌아왔다. 그래서 당장 운영 클러스터를 세워가며 defrag를 돌리는 대신 <b>관망·모니터링</b>으로 결정했다. 대신 재발 시 바로 집어들 대응 플랜을 문서로 남겼다. 급하게 손대다 defrag가 2차 장애를 만드는 걸 막으려는 목적이 컸다.
