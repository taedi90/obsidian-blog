...
### 2-1. 하드웨어 요구사항
- <b>Master Node</b>: 최소 2CPU, 4GB RAM
- <b>Worker Node</b>: 최소 1CPU, 2GB RAM
- <b>네트워크</b>: 모든 노드 간 SSH 통신 가능
- <b>스토리지</b>: 각 노드당 최소 20GB 여유 공간
...
> [!IMPORTANT]
> kube-proxy를 비활성화할 경우, 반드시 <b>대체 네트워크 솔루션</b>(Cilium, Istio 등)을 준비해야 한다. 그렇지 않으면 Service 간 통신이 불가능하다.
...
1. <b>CNI 설치</b>: kube-proxy를 비활성화한 경우 Cilium 등의 CNI를 설치
2. <b>Ingress Controller</b>: NGINX, Traefik 등의 인그레스 컨트롤러 설치
3. <b>스토리지</b>: Longhorn, NFS 등의 영구 스토리지 솔루션 구성
4. <b>모니터링</b>: Prometheus, Grafana 등의 모니터링 스택 설치
5. <b>백업</b>: etcd 백업 및 클러스터 백업 정책 수립

> [!NOTE]
> 프로덕션 환경에서는 반드시 <b>정기적인 백업 정책</b>을 수립하고, <b>고가용성 구성</b>을 통해 단일 장애점을 제거해야 한다.