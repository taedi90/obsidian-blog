...
### 앱등록
entraid 사이트에서 앱등록 페이지에 접속하여 새로운 앱을 등록해준다.

이거 뭐였더라 관리자랑 뭐랑 분리도 해줄 수 있고 이것저것있었던거같은데 일단 용도가 필요없을거같아 하나의 앱에 모든 것을 등록했다.

#### api-server 에 정보 넣기

#### kubectl 로 접근가능 확인
#### 리디렉션 uri 구성하기
콜백 주소가 필요한데 이걸 허용목록에 안넣으면 정상동작하지 않는다


- https://learn.microsoft.com/ko-kr/azure/aks/azure-ad-rbac?tabs=portal


이거 무슨 엔트라아이디 버전도 있고 뭐도 있고 매뉴얼도 나눠져있고 머리 터지는줄 알았다.
...
- <b>Rancher</b>, <b>HashiCorp Vault</b> 등 관리 플랫폼 도입 검토
