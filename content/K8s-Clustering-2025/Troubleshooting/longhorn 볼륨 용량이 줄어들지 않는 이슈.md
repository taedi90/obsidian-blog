...
이런 현상은 처음 겪는 것이 아니었다. 몇 년 전에도 동일한 이슈를 경험하고 해결 방법을 찾아봤던 기억이 있지만, 시간이 지나면서 다시 잊게 되었다.
...
Longhorn <b>v1.4.0</b> 이상부터는 볼륨 트리밍(Volume Trimming)을 지원한다. 이 기능으로 사용하지 않는 블록을 수동으로 회수할 수 있다.
